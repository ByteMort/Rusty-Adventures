...
pub fn display_auth() -> Html{
    ...
    let username:String = format!("Username: {}", store.username.as_deref().unwrap_or_default());
    let password:String = format!("Password: {}", store.password.as_deref().unwrap_or_default());
